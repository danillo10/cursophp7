...
class Category extends Model {
	...
	public static function updateFile()
	{
		...
		foreach ($categories as $row) {
			array_push($html, '<li><a href="/sites/trunk/danillo10/e-commerce/categories/'.$row['idcategory'].'">'.$row["descategory"].'</a></li>');
		}

		file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/sites/trunk/danillo10/e-commerce/views/categories-menu.html', implode('', $html));

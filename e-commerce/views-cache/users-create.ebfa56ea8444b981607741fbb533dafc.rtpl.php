...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/sites/trunk/danillo10/e-commerce/admin/users">Usuários</a></li>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/sites/trunk/danillo10/e-commerce/admin/users/create" method="post">
          <div class="box-body">
